...
import io.github.michaelcirkl.ubsa.client.streaming.FileUploadValidators;
import io.github.michaelcirkl.ubsa.client.streaming.WriteOptionsMappers;
...
import io.github.michaelcirkl.ubsa.client.streaming.ByteArrayRangeValidator;
...
public class GCPSyncClientImpl implements BlobStorageSyncClient {
    ...
    @Override
    public io.github.michaelcirkl.ubsa.Blob getBlob(String bucketName, String blobKey) {
    ...
    @Override
    public io.github.michaelcirkl.ubsa.Blob getBlobMetadata(String bucketName, String blobKey) {
    ...
    @Override
    public String createBlob(String bucketName, io.github.michaelcirkl.ubsa.Blob blob) {
        return exceptionHandler.handle(() -> {
    ...
    @Override
    public ListingPage<io.github.michaelcirkl.ubsa.Blob> listBlobs(String bucketName, String prefix, PageRequest request) {
        PageRequest pageRequest = GCPClientSupport.normalizePageRequest(request);
        return exceptionHandler.handle(() -> {
    ...
    @Override
    public Void createBucket(io.github.michaelcirkl.ubsa.Bucket bucket) {
        return exceptionHandler.handle(() -> {
            try {
